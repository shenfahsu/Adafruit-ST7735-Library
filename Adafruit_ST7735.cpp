...
Adafruit_ST7735::Adafruit_ST7735(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk, int8_t rst)
		: Adafruit_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, mosi, sclk, rst)
{
}
...
/*!
	...
	@param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7735::Adafruit_ST7735(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst)
		: Adafruit_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, spiClass, cs, dc, rst)
{
}
#endif // end !ESP8266
...
// Rather than a bazillion writecommand() and writedata() calls, screen initialization commands and arguments are organized in these tables stored in PROGMEM.
// The table may look bulky, but that's mostly the formatting -- storage-wise this is hundreds of bytes more compact than the equivalent code.  Companion function follows.
...
static const uint8_t PROGMEM
	Bcmd[] = {						// Init commands for 7735B screens
		...
		0x09, 0x16, 0x09, 0x20,				//	(Not entirely necessary, but provides accurate colors)
		0x21, 0x1B, 0x13, 0x19,
		0x17, 0x15, 0x1E, 0x2B,
		0x04, 0x05, 0x02, 0x0E,
		ST7735_GMCTRN1,		16+ST_CMD_DELAY,	// 14: Gamma Adjustments (neg. polarity), 16 args + delay:
		0x0B, 0x14, 0x08, 0x1E,				//	(Not entirely necessary, but provides accurate colors)
		0x22, 0x1D, 0x18, 0x1E,
		0x1B, 0x1A, 0x24, 0x2B,
		0x06, 0x06, 0x02, 0x0F,
		10,						//	10 ms delay
